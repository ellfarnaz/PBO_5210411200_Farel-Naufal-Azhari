...
class computerPart_1():
    def __init__(self, part,pabrikan,) :
        self.part = part
        self.pabrikan = pabrikan

class computerPart_2() : 
    def __init__(self,nama ,harga) :
        self.nama = nama
        self.harga = harga

class processor(computerPart_1,computerPart_2):
...
class ram(computerPart_1,computerPart_2):
...
class hardDisk(computerPart_1,computerPart_2):
...
hdd = hardDisk('Hard Disk','Seagate', 'HDD 2.5 inch', 295000, '500GB', 7200)
